...
class Evaluator(Callback):
    ...
    def evaluate(self):
        ...
        print(self.val_generator.nb_samples,self.val_generator.batch_size)
        print('nb',self.val_generator.nb_samples,'bs',self.val_generator.batch_size)
